...
export default function Navbar () {
    ...
    <div className="h-20">
        <AppBar elevation={0} className="fixed h-20">
            <Toolbar className="bg-white px-12 h-full flex justify-between items-center">
                <div className="flex items-center">
                  <img src={gctLogo.src} />  
                  <p className="text-lg ml-4 uppercase text-slate-900 font-bold"> government college of technology </p>
                </div>
